...
class Visualizer {
   ...
   public:
    ...
    void (Visualizer::*sorting_function)();
    ...
    Visualizer() : generator(std::random_device{}()) {
    ...
    void Draw() {
        ...
        if (this->sorting_function == &Visualizer::bogo_sort_step) {
            ...
            for (int i = 0; i < bogo_arr_size; i++) {
                int on_screen_size =
                    ROW_MAX_HEIGHT / bogo_arr_size * bogo_arr[i];
                Color color;
                ...
                DrawRectangle(
                    50 +
                        static_cast<int>(i *
                                         (ActualWindowWidth / bogo_arr_size)) +
        ...
        for (int i = 0; i < ROW_COUNT; i++) {
            ...
            DrawRectangle(50 + static_cast<int>(i * 5) +
                              (ActualWindowWidth - WINDOW_WIDTH) / 2,
                          ActualWindowHeight - static_cast<int>(on_screen_size),
                          5, static_cast<int>(on_screen_size), color);
        }
    }
